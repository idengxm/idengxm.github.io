...
Associate Professor\\
\href{http://english.is.cas.cn/}{Beijing Key Laboratory of Human-Computer Interaction}\\
\href{http://english.is.cas.cn/}{Institute of Software, Chinese Academy of Sciences}\\
4\# South Fourth Street\\
Zhong Guan Cun, Beijing 100190, P.R. China}
...
\textit{E-mail:} \email{idengxm@gmail.com}\\
\textit{WWW:} \href{http://www.idengxm.com/}{www.idengxm.com}}
...
\textbf{Computer vision:} specifically related to camera calibration,
3D reconstruction, omnidirectional vision, simultaneous-localization and mapping (SLAM),
human motion tracking and synthesis

\section{Academic Appointments}

\textbf{Associate Professor} \hfill {July 2011 to present}
\begin{innerlist}

    \item[] \href{http://www.cse.ohio-state.edu/}{Beijing Key Laboratory of Human-Computer Interaction},
            \href{http://www.osu.edu/}{Institute of Software, Chinese Academy of Sciences}
\end{innerlist}

\textbf{Research Fellow} \hfill {April 2012 to June 2013}
\begin{innerlist}

    \item[] \href{http://ece.nus.edu.sg/}{Department of Electrical \& Computer Engineering},
            \href{http://www.nus.edu.sg/}{National University of Singapore (NUS)}
    \begin{innerlist}
        \item Advisor: \href{http://www.ece.nus.edu.sg/stfpage/eletp/Index.htm}{Professor Ping Tan}
    \end{innerlist}

\end{innerlist}

\textbf{Assistant Professor} \hfill {June 2010 to June 2011}
\begin{innerlist}
    \item[] \href{http://www.cse.ohio-state.edu/}{Beijing Key Laboratory of Human-Computer Interaction},
            \href{http://www.osu.edu/}{Institute of Software, Chinese Academy of Sciences}
\end{innerlist}

\textbf{Postdoctoral Research Fellow} \hfill {January 2008 to May 2010}
\begin{innerlist}
    \item[] \href{http://vr.ict.ac.cn/}{Virtual Reality Laboratory},
            \href{http://english.ict.cas.cn//}{Institute of Computing Technology, Chinese Academy of Sciences}
    \begin{innerlist}
       \item Advisor: \href{http://vr.ict.ac.cn/people/backup/default_c.htm}{Professor Zhaoqi Wang}
       \item Also working with \href{http://vr.ict.ac.cn/}{Professor Shihong Xia}
    \end{innerlist}
\end{innerlist}
...
\section{Awards and Honors}
 ...
 \begin{innerlist}
    ...
    \item K.C.Wong post-doctoral fellowship award in 2009 (Awarded
annually to 50 post-doctoral research fellows from all institutes
of Chinese Academy of Sciences).

    \item Member of Youth Innovation Promotion Association, Chinese Academy of Sciences.
...
\section{Selected Refereed Journal Publications}

\begin{bibenum}
    \item Xiaoming Deng, Fuchao Wu, Yihong Wu, Fuqing Duan, Liang Chang, and Hongan Wang. Self-calibration of Hybrid Central Catadioptric and Perspective Cameras. \emph{Computer Vision and Image Understanding} 116(6): 715-729 (2012)

    \item Fuqing Duan, Fuchao Wu, Mingquan Zhou, Xiaoming Deng, and Yun Tian. Calibrating Effective Focal Length for Central Catadioptric Cameras using One Space Line. \emph{Pattern Recognition Letters} 33(5): 646-653 (2012)

    \item Hui Zeng, Xiaoming Deng, and Zhanyi Hu. A New Normalized Method on Line-based Homography Estimation. \emph{Pattern Recognition Letters} 29(9): 1236-1244 (2008)

    \item Liang Chang, Xiaoming Deng, Suiwu Zheng, Yongqing Wang. Scaling Up Kernel Grower Clustering Method for Large Data Sets via Core-sets. \emph{Acta Automatica Sinica} 34 (3): 376-382(2008)

    \item Xiaoming Deng, Fuchao Wu, Yihong Wu. An Easy Calibration Method for Central Catadioptric Cameras,  \emph{Acta Automatica Sinica} (2007)
...
\begin{bibenum}
    ...
    \item Xiaoming Deng, Jie Liu, Feng Tian, Liang Chang, Hongan Wang. Motion Estimation of Multiple Depth Cameras Using Spheres. \emph{ICIP} 2014..

    \item Xiaoming Deng, Shihong Xia, Wenzhong Wang, Zhaoqi Wang, Liang Chang, Hongan Wang. Automatic Gait Motion Capture with Missing-marker Fillings. \emph{ICPR} 2014.

    \item Zhenglong Zhou, Bo Shu, Shaojie Zhuo, Xiaoming Deng, Ping Tan, Stephen Lin. Image-based Clothes Animation for Virtual Fitting. \emph{SIGGRAPH Asia} 2012 Technique Briefs.

    \item Liang Chang, Xiaoming Deng, Mingquan Zhou, Fuqing Duan, Zhongke Wu: Smoothness-constrained Face Photo-sketch Synthesis using Sparse Representation. \emph{ICPR} 2012: 3025-3029

    \item Xiaoming Deng, Fuchao Wu, Yihong Wu, Liang Chang, Wei Liu, Hongan Wang: Calibration of Central Catadioptric Camera with One-dimensional Object undertaking General Motions. \emph{ICIP} 2011: 637-640

    \item Liang Chang, Mingquan Zhou, Yanjun Han, Xiaoming Deng. Face Sketch Synthesis via Sparse Representation. \emph{ICPR} 2010: 2146-2149

    \item Wenzhong Wang, Xiaoming Deng, Xianjie Qiu, Shihong Xia, Zhaoqi Wang. Learning Local Models for 2D Human Motion Tracking. \emph{ICIP} 2009: 2589-2592

    \item Xiaoming Deng, Fuchao Wu, Yihong Wu, Fuqing Duan. Visual Metrology with Uncalibrated Radial Distorted Images. \emph{ICPR} 2008.
...
%        from stochastic robotics. In: 2013 International Symposium on
%        Biomathematics and Ecology Education and Research~(BEER~2013),
%        Arlington, VA, October 11--13, 2013.
%
...
%        Ecology Education and Research~(BEER~2013), Arlington, VA,
%        October 11--13, 2013.
%
...
%        P.~Michelucci~(Ed.), \emph{Handbook of Human Computation}.
%        2013. In press.
%\end{bibenum}
...
%
%\begin{bibenum}
%    \item Pavlic, T.P. The Economic Framework: Using constrained
%        optimization to unify the ideal free distribution, the marginal
%        value theorem, and the geometric framework of nutrition.
%
...
%        Office, 2013. Submitted.
%
%    \item Senior staff,
%        ``Biologically-inspired strategies for collective transport and
%        construction by multi-robot systems'', NSF, RI, 2013. Submitted.
%
%    \item Co\-/PI,
...
\begin{innerlist}
    \item Committee, Computer Vision Task Forces Forum, China Computer Federation.
\end{innerlist}

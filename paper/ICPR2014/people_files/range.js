...
function showTitlePane(state,txt,iLeft,iTop) 
{
		...
		if (loadingPane == null) {
			...
			el.style.cssText="background-color:#FFFFFF; padding:15px; display:none;font-family:宋体;font-size:14px;font-weight:bold;line-height:140%; border:5px solid #D8EFFF;position:absolute; right:1px; top:1px; bottom:1px; left:1px;width:18%; height:6%; z-index:10000;filter:alpha(opacity=90);";
		...
		if(typeof txt == "string")
		{
			...
			if(typeof iTop == "number")
				loadingPane.style.top = document.documentElement.scrollTop+iTop;
		}
		else
...
divElm.style.left = Left+imgleft+28;
divElm.style.top = Top+imgtop+15;

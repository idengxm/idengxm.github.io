...
function drawCld(SY,SM) {
   ...
   for(i=0;i<42;i++) {
	 ...
	 if(verifyDate<'2006-06-11')
	 {
		 cObj.href = "http://www.people.com.cn/GB/paper464/review/200603.html";
	 }
	 else if(verifyDate>="2006-06-11"&&verifyDate<"2008-06-11"){
		cObj.href = "http://paper.people.com.cn/scb/html/2008-06/11/node_193.htm";
	 }
	 else
	 {
		 if(oPeriod)
